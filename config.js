...
module.exports = {
	...
	AUDIO_DATA: process.env.AUDIO_DATA || "ALI-XMD;ALI-BALOCH;https://files.catbox.moe/cgft4d.jpg",
	AUTO_STATUS_VIEW: toBool(process.env.AUTO_STATUS_VIEW || "true"),
	BOT_INFO: process.env.BOT_INFO || "ALI-XMD;ALI BALOCH;https://files.catbox.moe/cgft4d.jpg",
	CALL_BLOCK: toBool(process.env.CALL_BLOCK || "false"),
	CALL_BLOCK_MSG: process.env.CALL_BLOCK_MSG || "_Calls are not allowed. Please don’t call again!._",
	DATABASE_URL,
	DATABASE,
	DISABLE_PM: toBool(process.env.DISABLE_PM || "false"),
	HANDLERS: (process.env.HANDLERS || process.env.HANDLER || "sarkar").trim(),
	...
	SESSION_ID: process.env.SESSION_ID || "A-S-W-I-N-S-P-A-R-K-Y:88c832381e870c88bb25b61fe4077734",
	START_MSG: toBool(process.env.START_MSG || "true"),
	STICKER_DATA: process.env.STICKER_DATA || `ALI-XMD;ALI BALOCH`,
	SUDO: process.env.SUDO || "923253617422",
